...
int main(){
	...
	system("sh /home/mr/Downloads/camera/enable_camera.sh");
	imshow("original", frame);
	int num_img = 0;
	boost::format left_fmt("../data/left_img/left_img_%02d.jpg");
	boost::format right_fmt("../data/right_img/right_img_%02d.jpg");
